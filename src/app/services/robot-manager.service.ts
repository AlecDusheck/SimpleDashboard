...
export class RobotManagerService {
    ...
    constructor(private electronService: ElectronService, private zone: NgZone, private config: ConfigService) {
        // On WPILIB error
    ...
    connect(): void {
        ...
        // Connect to robot
        this.electronService.ipcRenderer.send('connect', this.config.settings.robotConnection.addr);
    }
}
